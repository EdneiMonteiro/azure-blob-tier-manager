...
Esta ferramenta pode **alterar o access tier** de Storage Accounts e blobs do Azure, o que pode:

- Gerar custos de retirada/exclusão antecipada (Cool/Cold/Archive)
- Deixar dados offline (Archive exige reidratação para leitura)
- Impactar aplicações que dependem do desempenho do tier atual

Use o modo **somente leitura** / **dry-run** antes de qualquer alteração e valide o impacto.
